...
const pricingPlans = [
  {
    ...
    features: [
      "Custom Website Design: Basic, Up to 3 Sections",
      ...
      "CMS Integration: WordPress or Drupal Basic Setup",
  ...
  },
  {
    ...
    features: [
      ...
      "CMS Integration: WordPress or Drupal Advanced Setup & Customization",
      "Technology Stack: React, Next.js, TypeScript",
  ...
  },
  {
    ...
    features: [
      ...
      "CMS Integration: WordPress or Headless CMS (Next.js/Drupal) Options",
      "Technology Stack: React, Next.js, TypeScript",
      "E-commerce Integration: Shopify or WooCommerce (Up to 10 Products)",
...
const lowTierPricingPlans = [
  {
    ...
    features: [
      ...
      "Technology Stack: Wordpress, Drupal or Shopify",
      "Revisions: 1 Round of Content Swaps (before launch)",
      "Post-Launch Support: 48 hours (for critical bug fixes)",
  ...
  },
  {
    ...
    features: [
      ...
      "Analytics Setup: Google Analytics Setup",
      "Technology Stack: Wordpress, Drupal or Shopify",
      "Revisions: 1 Full Round of Content & Small Layout Edits",
      "Post-Launch Support: 5 days (for critical bug fixes)",
  ...
  },
  {
    ...
    features: [
      ...
      "Post-Launch Support: 10 days (for bug fixes/questions)",
