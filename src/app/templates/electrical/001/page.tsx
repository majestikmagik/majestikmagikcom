        ...
        <div className={`bg-slate-50 text-slate-800 font-sans`}>
            ...
            <main>
                ...
                <section className="relative bg-slate-900 text-white py-20 md:py-32">
                    <video autoPlay loop muted playsInline className="absolute top-0 left-0 w-full h-full object-cover z-0 opacity-10">
                        <source src="/img/8488372-hd_1920_1080_30fps.mp4" type="video/mp4" />
                    ...
                    <div className="container mx-auto px-6">
                        <div className="flex flex-col md:flex-row items-center gap-12">
                            <div className="md:w-1/2">
                                <Image src="https://placehold.co/600x400/1E293B/FBBF24.png?text=Safe+%26+Secure&font=montserrat" alt="Electrician ensuring a safe and secure installation" className="rounded-lg shadow-2xl" width={600} height={400} />
                            </div>
                            <div className="md:w-1/2">
