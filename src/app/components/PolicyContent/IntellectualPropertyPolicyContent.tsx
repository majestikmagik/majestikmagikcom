...
export const IntellectualPropertyPolicyContent: React.FC = () => {
  return (
    <div className="text-slate-300 leading-relaxed space-y-4">
      <h2 className="text-2xl font-semibold text-slate-100 mb-1">Intellectual Property Policy</h2>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">1. Our Intellectual Property</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">2. Permitted Use of Our Content</h3>
        <p>
          Subject to these terms, you are granted a limited, non-exclusive, non-transferable, and revocable license to access and use the Site and its content for your personal and non-commercial use in Browse our services and potentially engaging with us.
        </p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">3. Prohibited Uses</h3>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">4. Trademarks</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">5. Copyright</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">6. Respect for the Intellectual Property of Others</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">7. Procedure for Making Claims of Copyright Infringement</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">8. Enforcement of Intellectual Property Rights</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">9. Changes to This Intellectual Property Policy</h3>
        <p>
