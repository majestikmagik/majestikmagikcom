...
export const PrivacyPolicyContent: React.FC = () => {
  return (
    <div className="text-slate-300 leading-relaxed space-y-4">
      <h2 className="text-2xl font-semibold text-slate-100 mb-1">Privacy Policy for Majestik Magik</h2>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">1. Information We Collect</h3>
        <p>We may collect the following types of personal information from you:</p>

        <h4 className="text-lg font-medium text-slate-200 mt-3 mb-1">Information You Provide Directly:</h4>
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
         ...
         <p>
          To enhance our services and provide support, we utilize an AI-powered chatbot. When you interact with our AI Chatbot, we may collect and store the conversation history.
        </p>
        <p>
          <strong>Please be aware that conversations with our AI Chatbot may be reviewed by our team members.</strong> This review process is conducted for purposes of quality assurance, to improve the performance and accuracy of our AI systems, and to ensure the safety and security of our platform. Do not share any sensitive personal information (such as financial details, health information, or government-issued identification numbers) in your chat conversations.
        </p>
      </div>

      {/* Section 2 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">2. How We Use Your Information</h3>
