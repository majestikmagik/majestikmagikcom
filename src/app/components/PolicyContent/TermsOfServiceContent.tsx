...
export const TermsOfServiceContent: React.FC = () => {
  return (
    <div className="text-slate-300 leading-relaxed space-y-4">
      <h2 className="text-2xl font-semibold text-slate-100 mb-1">Terms of Service for Majestik Magik</h2>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">1. Acceptance of Terms</h3>
        <p>
      ...
      {/* Section 2 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">2. Services Provided</h3>
      ...
      {/* Section 3 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">3. Client Responsibilities</h3>
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <li>Ensure that you have денег legal right to use any content, images, trademarks, or other materials you provide to us.</li>
      ...
      {/* Section 4 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">4. Payment Terms</h3>
      ...
      {/* Section 5 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">5. Intellectual Property</h3>
        <ul className="list-disc list-inside space-y-1 ml-4">
      ...
      {/* Section 6 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">6. Project Timeline</h3>
        <p>
      ...
      {/* Section 7 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">7. Warranties and Disclaimer</h3>
        <p>
          We warrant that the Services will be performed in a professional and workmanlike manner. However, to the maximum extent permitted by applicable law in the United States, we disclaim all other warranties, express or implied, including but not
      ...
      {/* Section 8 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">8. Limitation of Liability</h3>
        <p>
      ...
      {/* Section 10 */}
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">10. Termination</h3>
        <p>
      ...
      {/* Section 11 */}      
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">11. Governing Law and Dispute Resolution</h3>
        <p>
      ...
      {/* Section 12 */}
            <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">12. Entire Agreement</h3>
        <p>
      ...
      {/* Section 13 */}
           <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">13. Modifications to Terms</h3>
        <p>
      ...
      {/* Section 14 */}
           <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">14. Contact Us</h3>
