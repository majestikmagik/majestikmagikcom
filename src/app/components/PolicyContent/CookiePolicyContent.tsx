...
export const CookiePolicyContent: React.FC = () => {
  return (
    <div className="text-slate-300 leading-relaxed space-y-4">
      <h2 className="text-2xl font-semibold text-slate-100 mb-1">Cookie Policy for Majestik Magik</h2>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">1. What are Cookies?</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">2. How We Use Cookies</h3>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">3. Types of Cookies We Use</h3>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">5. Other Tracking Technologies</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">6. Changes to This Cookie Policy</h3>
        <p>
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-slate-200 mt-5 mb-1">7. Contact Us</h3>
