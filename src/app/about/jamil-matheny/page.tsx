...
const JamilMathenyContent: React.FC = () => {
    return (
        <div className="text-slate-300 leading-relaxed space-y-4">
            ...
            <p>Having experienced the challenges of entrepreneurship firsthand, Jamil is driven to alleviate the business pains of his clients. His vision for Majestik Magik is to provide businesses with not just a website, but a robust digital system that works to support their growth and success.</p>
        </div>
    );
};
