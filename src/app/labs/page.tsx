        ...
        <div className="text-slate-300 leading-relaxed space-y-12">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Link href="/img/insightmd_01.png"> <Image src="/img/insightmd_01.png" alt="Prototype 1" width={1000} height={1000} className="w-full h-auto rounded-lg shadow-lg border border-indigo-400" /></Link>
                    <Link href="/img/insightmd_04.png"> <Image src="/img/insightmd_04.png" alt="Prototype 4" width={1000} height={1000} className="w-full h-auto rounded-lg shadow-lg border border-indigo-400" /></Link>
                </div>
