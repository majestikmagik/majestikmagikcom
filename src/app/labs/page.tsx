                ...
                <div className="max-w-4xl mx-auto">
                    <ol className="relative border-l border-slate-700">                  
                        ...
                        <li className="mb-10 ml-4">
                            ...
                            <ul className="text-base font-normal text-slate-400 hover:text-indigo-400">- Secured and approved $2,000 in cloud credits from the <a href="https://cloud.google.com/startup">Google Cloud Startup Program</a> for the development of the Insight MD platform. </ul>
                            ...
                            <ul className="text-base font-normal text-slate-400 hover:text-indigo-400">- Sending email proposals to potential clinical partners. <b><a href="/data/research_sbir/A_Clinician-Centric_AI_Co-Pilot_for_Enhanced_Grading_and_Detection_of_Prostate_Cancer_on_MRI.pdf">[DOWNLOAD PDF]</a></b>  </ul>
